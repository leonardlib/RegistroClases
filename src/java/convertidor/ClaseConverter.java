...
@FacesConverter(value = "claseConverter")
public class ClaseConverter implements Converter {

    private ClaseFacade ejbFacade;
    ...
    private ClaseFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(ClaseFacade.class).get();
